        ...
        <div className="mt-3 space-y-3">
          {sortedGoals.length > 0 && (
            <div>
              <button
                ...
                className="w-full flex justify-between items-center p-2 bg-gray-100 dark:bg-gray-700 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-sm"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-medium mb-1">ティア</label>
                <select
                  value={targetTier}
              ...
              {targetTier !== 'MASTER' && targetTier !== 'GRANDMASTER' && targetTier !== 'CHALLENGER' && (
                <div>
                  <label className="block text-xs font-medium mb-1">ランク</label>
                  <select
                    value={targetRank}
            ...
            <div>
              <label className="block text-xs font-medium mb-1">目標LP</label>
              <input
                type="number"
                value={targetLP}
            ...
            <div>
              <label className="block text-xs font-medium mb-1">目標日付</label>
              <input
                type="date"
                value={targetDate}
